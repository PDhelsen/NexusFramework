...
namespace NxFr
{
	...
	public:
		...
		NEXUS_FRAMEWORK_API String(const String& Other);
		...
		NEXUS_FRAMEWORK_API String& Replace(StringView Old, StringView New);
		NEXUS_FRAMEWORK_API String& Assign(StringView OldText, StringView NewText, uint64 Offset = 0, uint64 Occurrence = 1, bool All = false);
		NEXUS_FRAMEWORK_API String& Insert(StringView ReferenceText, StringView NewText, uint64 Offset = 0, uint64 Occurrence = 1, bool All = false);
		NEXUS_FRAMEWORK_API String& Remove(StringView Text, uint64 Offset = 0, uint64 Occurrence = 1, bool All = false);
		...
		NEXUS_FRAMEWORK_API StringView ToView() const;
