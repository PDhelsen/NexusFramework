...
{
	return NxFr::Memory::Allocate(Size);
}
...
{
	NX_ASSERT(false, Default, "Not supported new operator");
	return nullptr;
}
...
{
	NX_ASSERT(false, Default, "Not supported delete operator");
}
