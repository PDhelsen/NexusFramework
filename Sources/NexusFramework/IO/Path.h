...
namespace NxFr
{
	...
	public:
		struct Info
		{
			NEXUS_FRAMEWORK_API Info(NxFr::StringView Data);
			NEXUS_FRAMEWORK_API Info(const Info& Other) = delete;
			NEXUS_FRAMEWORK_API Info(Info&& Other) noexcept = delete;
			NEXUS_FRAMEWORK_API ~Info() = default;

			NEXUS_FRAMEWORK_API bool Has(bool HasDrive, bool HasFolder, bool HasName, bool HasExtension) const;
			NEXUS_FRAMEWORK_API StringView Get(bool GetDrive, bool GetFolder, bool GetName, bool GetExtension) const;
			NEXUS_FRAMEWORK_API void Change(StringView ChangeDrive, StringView ChangeFolder, StringView ChangeName, StringView ChangeExtension, String& Buffer) const;
