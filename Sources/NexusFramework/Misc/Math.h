...
namespace NxFr
{
	namespace Math
	{
		...
		NEXUS_FRAMEWORK_API constexpr	float	Square				(float		X);
		NEXUS_FRAMEWORK_API constexpr	double	Square				(double		X);
		NEXUS_FRAMEWORK_API constexpr	int8	Square				(int8		X);
		NEXUS_FRAMEWORK_API constexpr	int16	Square				(int16		X);
		NEXUS_FRAMEWORK_API constexpr	int32	Square				(int32		X);
		NEXUS_FRAMEWORK_API constexpr	int64	Square				(int64		X);
		NEXUS_FRAMEWORK_API constexpr	uint8	Square				(uint8		X);
		NEXUS_FRAMEWORK_API constexpr	uint16	Square				(uint16		X);
		NEXUS_FRAMEWORK_API constexpr	uint32	Square				(uint32		X);
		NEXUS_FRAMEWORK_API constexpr	uint64	Square				(uint64		X);
		...
		NEXUS_FRAMEWORK_API constexpr	bool	IsPowerOfTwo		(uint8		X);
		NEXUS_FRAMEWORK_API constexpr	bool	IsPowerOfTwo		(uint16		X);
		NEXUS_FRAMEWORK_API constexpr	bool	IsPowerOfTwo		(uint32		X);
		NEXUS_FRAMEWORK_API constexpr	bool	IsPowerOfTwo		(uint64		X);
		NEXUS_FRAMEWORK_API constexpr	uint8	NextPowerOfTwo		(uint8		X);
		NEXUS_FRAMEWORK_API constexpr	uint16	NextPowerOfTwo		(uint16		X);
		NEXUS_FRAMEWORK_API constexpr	uint32	NextPowerOfTwo		(uint32		X);
		NEXUS_FRAMEWORK_API constexpr	uint64	NextPowerOfTwo		(uint64		X);
		...
		NEXUS_FRAMEWORK_API constexpr	bool	IsPrime				(uint8		X);
		NEXUS_FRAMEWORK_API constexpr	bool	IsPrime				(uint16		X);
		NEXUS_FRAMEWORK_API constexpr	bool	IsPrime				(uint32		X);
		NEXUS_FRAMEWORK_API constexpr	bool	IsPrime				(uint64		X);
		NEXUS_FRAMEWORK_API constexpr	uint8	NextPrime			(uint8		X);
		NEXUS_FRAMEWORK_API constexpr	uint16	NextPrime			(uint16		X);
		NEXUS_FRAMEWORK_API constexpr	uint32	NextPrime			(uint32		X);
		NEXUS_FRAMEWORK_API constexpr	uint64	NextPrime			(uint64		X);
	}
}
