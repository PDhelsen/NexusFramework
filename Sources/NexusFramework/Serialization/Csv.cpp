...
namespace NxFr
{
	...
	{
		NX_ASSERT(Data.First().IsValidIndex(Column), Default, "Column %llu doesn't exist");
	...
	{
		NX_ASSERT(Data.IsValidIndex(Row), Default, "Row %llu doesn't exist");
	...
	{
		NX_ASSERT(Data.IsValidIndex(Row), Default, "Row %llu doesn't exist");
		NX_ASSERT(Data.Get(Row).IsValidIndex(Column), Default, "Column %llu doesn't exist");
