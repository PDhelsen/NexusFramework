...
namespace NxTs
{
	...
	TEST(Memory, StackAllocator)
	{
		...
		bool* Test1 = (bool*)NxEn::Memory::Allocate(sizeof(bool), Allocator, alignof(bool));
		*Test1 = true;
		ASSERT_EQ(Allocator->FreeAmount(), 510);

		int16* Test2 = (int16*)NxEn::Memory::Allocate(sizeof(int16), Allocator, alignof(int16));
		*Test2 = 8;
		ASSERT_EQ(Allocator->FreeAmount(), 506);

		int32* Test3 = (int32*)NxEn::Memory::Allocate(sizeof(int32), Allocator, alignof(int32));
		*Test3 = 255;
		ASSERT_EQ(Allocator->FreeAmount(), 500);

		NxEn::Memory::Free(Test2, Allocator);
		ASSERT_EQ(Allocator->FreeAmount(), 510);

		int64* Test4 = (int64*)NxEn::Memory::Allocate(sizeof(int64), Allocator, alignof(int64));
		*Test4 = 1024;
		...
		int32* Test5 = (int32*)NxEn::Memory::Allocate(sizeof(int32) * 5, Allocator, alignof(int32));
		Test5[0] = 5;
		Test5[1] = 4;
		Test5[2] = 3;
		Test5[3] = 2;
		...
		MemoryTest* Test10 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator, alignof(MemoryTest));
		Test10->Value = 1;
		Test10->Test = 0xffffffff;

		MemoryTest* Test11 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator, alignof(MemoryTest));
		Test11->Value = 1;
		Test11->Test = 0xffffffff;

		NxEn::Memory::Free(Test11, Allocator);

		MemoryTest* Test12 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator, alignof(MemoryTest));
		Test12->Value = 1;
	...
	TEST(Memory, PoolAllocator)
	{
		...
		MemoryTest* Test2 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test2->Value = 2;
		Test2->Test = 0xffffffff;

		MemoryTest* Test3 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test3->Value = 3;
		Test3->Test = 0xffffffff;

		MemoryTest* Test4 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test4->Value = 4;
		Test4->Test = 0xffffffff;

		MemoryTest* Test5 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test5->Value = 5;
		...
		NxEn::Memory::Free(Test1, Allocator);
		NxEn::Memory::Free(Test3, Allocator);
		...
		MemoryTest* Test7 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test7->Value = 7;
		Test7->Test = 0xffffffff;

		MemoryTest* Test8 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test8->Value = 8;
		Test8->Test = 0xffffffff;

		MemoryTest* Test9 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test9->Value = 9;
		...
		MemoryTest* Test10 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test10->Value = 10;
		Test10->Test = 0xffffffff;
		...
		MemoryTest* Test15 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test15->Value = 1;
		Test15->Test = 0xffffffff;

		MemoryTest* Test11 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test11->Value = 1;
		Test11->Test = 0xffffffff;

		MemoryTest* Test12 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test12->Value = 1;
		Test12->Test = 0xffffffff;

		MemoryTest* Test13 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test13->Value = 1;
		Test13->Test = 0xffffffff;

		NxEn::Memory::Free(Test13, Allocator);

		MemoryTest* Test14 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test14->Value = 1;
		Test14->Test = 0xffffffff;

		NxEn::Memory::Free(Test11, Allocator);
		NxEn::Memory::Free(Test12, Allocator);

		MemoryTest* Test16 = (MemoryTest*)NxEn::Memory::Allocate(sizeof(MemoryTest), Allocator);
		Test16->Value = 1;
	...
	TEST(Memory, HeapAllocator)
	{
		...
		MemoryTest* Test9 = (MemoryTest*)NxEn::Memory::Reallocate(Test7, sizeof(MemoryTest) * 5, Allocator);
		Test9[3].Value = 10;
		...
		MemoryTest* Test10 = (MemoryTest*)NxEn::Memory::Reallocate(Test9, sizeof(MemoryTest) * 2, Allocator);
